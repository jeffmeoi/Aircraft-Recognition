...
class CustomModel(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(self.channels, self.inplanes, kernel_size=7, stride=1, padding=3, bias=False)
        ...
        self.layer5 = self._make_layer(block, 512, 1, stride=2,
                                       dilate=replace_stride_with_dilation[3])
        self.layer6 = self._make_layer(block, 512, 1, stride=2,
...
if __name__ == '__main__':
    ...
    # 默认输入图片数据大小为512*512
    net = CustomModel(BasicBlock, [2, 2, 2, 2], num_classes=10)
