...
epochs = 100
img_size = 80
model_file = 'keypoints_detect_network_80.pth'
...
class KeypointDataset(Dataset):
    def __init__(self, annotations_file=utils.annotations_dir + 'rotations_80.json', 
                 img_dir=utils.rotation_dir_80):
...
train_data = KeypointDataset(annotations_file=utils.annotations_dir + 'keypoints_train_set_80.json')
test_data = KeypointDataset(annotations_file=utils.annotations_dir + 'keypoints_test_set_80.json')
